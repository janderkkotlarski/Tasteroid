	 ...
	 values(walues), normal_radius(0.4*sizes.y), circlents(), circlent_amount(kirklent_amount)
{
	...
	const circle_entity circlent(0, normal_radius, circlent_posit, circlent_color);
...
int main()
{
	...
	const std::string program_name{"Rectangle Circles V0.1"};
	...
	rectent_circlent_amounts.push_back(100);
	rectent_circlent_amounts.push_back(50);
	rectent_circlent_amounts.push_back(75);
	rectent_circlent_amounts.push_back(141);
